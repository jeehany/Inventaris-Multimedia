                    ...
                    <form action="{{ route('borrowings.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="return_date" id="return_date" value="{{ old('return_date') }}" class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                            </div>
                        </div>
