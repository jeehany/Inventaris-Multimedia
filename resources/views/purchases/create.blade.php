<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-slate-800 leading-tight">
            {{ __('Pengajuan Pengadaan Baru (Rencana Anggaran Belanja)') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('purchases.store') }}" method="POST" id="rabForm">
                @csrf
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" name="date" value="{{ old('date', date('Y-m-d')) }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 bg-slate-50 p-2.5" required>
                ...
                <div class="flex justify-end gap-3 mb-10">
                    <a href="{{ route('purchases.request') }}" class="px-6 py-3 bg-white text-slate-700 font-bold rounded-xl border border-slate-300 hover:bg-slate-50 transition shadow-sm">
                        Batal
                    </a>
