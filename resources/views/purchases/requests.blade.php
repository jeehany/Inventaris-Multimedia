                    ...
                    <div class="flex flex-col md:flex-row justify-between items-end md:items-center gap-4 mb-8">
                        ...
                        @auth
                            ...
                            @if(in_array(auth()->user()->role, ['kepala', 'head']))
                                <a href="{{ route('purchases.request.export', request()->query()) }}" class="w-full md:w-auto inline-flex items-center justify-center bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2.5 px-5 rounded-lg shadow-lg hover:shadow-emerald-500/30 transition duration-150 ease-in-out text-sm gap-2 whitespace-nowrap">
