                ...
                <div class="p-8 text-slate-800">
                    ...
                    <form action="{{ route('maintenances.store') }}" method="POST">
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="note" rows="4" class="w-full border-slate-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 placeholder-slate-400" placeholder="Jelaskan detail kerusakan atau perawatan yang dibutuhkan..." required>{{ old('note') }}</textarea>
                        </div>
