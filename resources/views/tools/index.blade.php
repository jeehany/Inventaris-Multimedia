                                            ...
                                            <div class="flex justify-center items-center space-x-2">
                                                ...
                                                @auth
                                                    @if(!auth()->user()->isHead())
                                                        ...
                                                        {{-- Hapus (Soft Delete) --}}
                                                        <button type="button" 
                                                                onclick="openDeleteModal('{{ route('tools.destroy', $tool->id) }}', 'Hapus Aset {{ $tool->tool_name }}?', 'Anda akan menghapus aset <strong>{{ $tool->tool_name }}</strong> (<span class=\'font-mono\'>{{ $tool->tool_code }}</span>).<br>Data akan dipindahkan ke <strong>Trash (Sampah)</strong>.')" 
