...
class BorrowingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // 1. Logika Search (Mencari Nama Peminjam atau Kode Peminjam)
        ...
        // 2. Logika Filter Status (Dipinjam / Kembali)
        ...
        // Ambil data (terbaru di atas) + Pagination (agar tidak berat load 1000 data)
