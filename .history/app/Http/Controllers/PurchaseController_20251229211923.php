    ...
    public function process(Request $request, $id)
{
    ...
    // 3. Update Data (Simpan Harga Asli & Ubah Status)
    $purchase->update([
        'actual_unit_price' => $request->actual_unit_price, // Simpan harga nota
        'status' => 'approved', // Atau 'completed' sesuai alur Anda
        'is_purchased' => true, // Tandai sudah dibeli
    ]);

    // 4. Redirect
    return redirect()->back()->with('success', 'Transaksi diproses. Harga realisasi berhasil disimpan.');
}
}