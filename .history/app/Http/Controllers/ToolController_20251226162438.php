...
class ToolController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        // 1. VALIDASI: Cegah hapus jika sedang dipinjam atau maintenance
        ...
        // 2. UPDATE STATUS: Ubah jadi 'disposed' sebelum dihapus
        // Tujuannya: Agar di database tercatat barang ini status terakhirnya adalah "dibuang/afkir"
        $tool->availability_status = 'disposed'; 
        $tool->save();

        // 3. SOFT DELETE: Ini yang memindahkan ke "Inventaris Tak Terpakai"
        $tool->delete(); 
