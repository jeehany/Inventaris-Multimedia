...
class MaintenanceController extends Controller
{
    ...
    {
        // REVISI: Ambil semua alat (karena kolom 'status' belum ada di database)
        $tools = Tool::all();
        
        // Ambil data tipe maintenance
    ...
    public function store(Request $request)
    {
        ...
        // REVISI: Bagian ini dimatikan dulu karena kolom 'status' tidak ada di tabel tools.
        // Jika nanti kolom sudah dibuat, silakan uncomment (hapus tanda //).
    ...
    public function update(Request $request, Maintenance $maintenance)
    {
        ...
        if ($request->has('complete_maintenance')) {
            ...
            // REVISI: Dimatikan dulu (kolom status belum ada)
            /*
    ...
    {
        // REVISI: Logika update status dimatikan dulu
        /*
