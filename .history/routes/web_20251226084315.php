...
Route::middleware('auth')->group(function () {
    ...
    // --- Peminjam & Peminjaman ---
Route::get('/borrowings/export-pdf', [App\Http\Controllers\BorrowingController::class, 'exportPdf'])->name('borrowings.exportPdf');    Route::resource('borrowers', BorrowerController::class);
