                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                        ...
                        <form action="{{ route('borrowings.index') }}" method="GET" class="flex flex-col md:flex-row gap-2 w-full md:w-auto items-center">
                            ...
                            <a href="{{ route('borrowings.exportPdf', request()->query()) }}" target="_blank" class="bg-red-600 text-b px-4 py-2 rounded-md hover:bg-red-700 text-sm flex items-center justify-center gap-1 w-full md:w-auto" title="Cetak Laporan PDF sesuai filter">
