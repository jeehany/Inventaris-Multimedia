            ...
            <div class="inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-md sm:w-full">
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                        ...
                        <div class="mb-2">
                            <input type="text" name="category_name" required class="w-full border-gray-300 rounded-md shadow-sm mb-2" placeholder="Contoh: Elektronik">
                            <input type="text" name="code" maxlength="10" class="w-full border-gray-300 rounded-md shadow-sm" placeholder="Kode prefix (Contoh: LPT)">
                        </div>
                    </div>
