                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                    <option value="approved" selected>Approved (Barang Masuk)</option>
                                    <option value="pending">Pending (Pesanan)</option>
                                    <option value="rejected">Rejected (Batal)</option>
                                </select>
                                <p class="text-xs text-gray-500 mt-1">*Jika Approved, stok alat otomatis bertambah.</p>
                            </div>
                        </div>
                    </div>
                </div>
