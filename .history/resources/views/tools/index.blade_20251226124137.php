            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        {{-- TOMBOL EXPORT PDF DITAMBAHKAN DISINI --}}
<a href="{{ route('tools.export_pdf', request()->query()) }}" target="_blank" class="ml-2 bg-red-600 text-white px-4 py-2 rounded-md text-sm hover:bg-red-700 flex items-center gap-1">
