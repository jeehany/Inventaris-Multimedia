                ...
                <div class="bg-white p-6 shadow-sm rounded-lg">
                    ...
                    <form action="{{ route('maintenances.update', $maintenance->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-lg font-bold">{{ $maintenance->tool->tool_name }}</div>
                        </div>
                ...
                <div class="bg-white p-6 shadow-sm rounded-lg border-2 {{ $maintenance->status == 'completed' ? 'border-green-400' : 'border-indigo-100' }}">
                    ...
                    @if($maintenance->status == 'in_progress')
                        ...
                        <form action="{{ route('maintenances.update', $maintenance->id) }}" method="POST">
                            ...
                            <div class="bg-blue-50 p-4 rounded-md mb-4 text-sm text-blue-800">
                                ℹ️ Jika diklik "Selesai", alat akan otomatis menjadi <b>Available</b> kembali.
                            </div>
                    ...
                    @else
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="text-green-600 font-bold text-xl">Rp {{ number_format($maintenance->cost, 0, ',', '.') }}</div>
                            </div>
                            <div class="bg-green-100 p-3 rounded text-center text-green-800 font-bold mt-4">
                                Status: SELESAI
                            </div>
                            <div class="text-center mt-4">
                                <a href="{{ route('maintenances.index') }}" class="text-gray-500 underline text-sm">Kembali ke daftar</a>
                            </div>
                        </div>
                    @endif
                </div>
