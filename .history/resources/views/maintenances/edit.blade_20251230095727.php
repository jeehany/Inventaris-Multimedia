                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white p-6 shadow-sm rounded-lg">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="action_taken" rows="3" class="w-full border-gray-300 rounded-md shadow-sm text-sm">{{ $maintenance->action_taken }}</textarea>
                        </div>
                        ...
                        @if($maintenance->status != 'completed')
                            <div class="mt-4 text-right">
                                ...
                                <button type="submit" name="action" value="update_info" class="text-sm bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 shadow">
                    ...
                    <div class="bg-white p-6 shadow-sm rounded-lg border-2 {{ $maintenance->status == 'completed' ? 'border-green-400' : 'border-gray-100' }}">
                        ...
                        @if($maintenance->status != 'completed')
                            ...
                            <div class="bg-yellow-50 p-3 rounded-md mb-4 text-xs text-yellow-800 border border-yellow-200">
                                ...
                                <p>Klik tombol di bawah untuk Menutup status perbaikan sekaligus menyimpan semua data.</p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="cost" value="{{ $maintenance->cost > 0 ? $maintenance->cost : 0 }}" min="0" class="w-full border-gray-300 rounded-md shadow-sm">
                            </div>

                            <div class="mt-6">
                                {{-- name="action" value="complete" sebagai penanda di controller --}}
                                <button type="submit" name="action" value="complete" class="w-full bg-green-600 text-white font-bold py-3 px-4 rounded hover:bg-green-700 shadow-lg transform transition hover:scale-105">
