                            ...
                            @forelse ($borrowers as $borrower)
                                <tr x-data="{ showModal: false }">
                                    <td class="border px-4 py-2 text-center align-middle">
                                        @if($borrower->photo)
                                            <img src="{{ asset('storage/' . $borrower->photo) }}" 
                                                alt="Foto {{ $borrower->name }}" 
                                                class="w-20 h-20 rounded-lg object-cover mx-auto border border-gray-200 shadow-sm">
                                        @else
                                            <div class="w-20 h-20 rounded-lg bg-gray-100 flex items-center justify-center mx-auto border border-gray-200 text-gray-400">
