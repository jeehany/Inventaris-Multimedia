                                            ...
                                            <div class="flex justify-center items-center space-x-3">
                                                ...
                                                <?php if(auth()->guard()->check()): ?>
                                                    <?php if(!auth()->user()->isKepala()): ?>
                                                        ...
                                                        <button type="button" onclick="openDeleteModal('<?php echo e(route('maintenances.destroy', $item->id)); ?>', 'Hapus Data Perbaikan?', 'Yakin ingin menghapus data ini? Status aset akan dikembalikan ke kondisi sebelumnya.')" class="text-rose-600 hover:text-rose-900 bg-rose-50 hover:bg-rose-100 p-2 rounded-lg transition" title="Hapus">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
