                                            ...
                                            <div class="flex justify-center items-center space-x-3">
                                                ...
                                                <?php if(auth()->guard()->check()): ?>
                                                    <?php if(!auth()->user()->isHead()): ?>
                                                        ...
                                                        <form action="<?php echo e(route('maintenances.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Hapus data perbaikan ini? Status alat akan dikembalikan.');">
                                                            <?php echo csrf_field(); ?>
