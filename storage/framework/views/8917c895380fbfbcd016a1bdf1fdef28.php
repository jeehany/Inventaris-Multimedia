                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if(!auth()->user()->isHead()): ?>
                                                <div class="flex justify-center items-center gap-3">
                                                    ...
                                                    <form action="<?php echo e(route('vendors.destroy', $vendor->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus vendor ini? Data aset terkait mungkin akan kehilangan referensi vendornya.');">
                                                        <?php echo csrf_field(); ?>
