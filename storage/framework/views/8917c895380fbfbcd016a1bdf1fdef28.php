            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-slate-200">
                <div class="p-6 md:p-8 text-slate-800">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-end md:items-center gap-4 mb-8">
                        ...
                        <form action="<?php echo e(route('vendors.index')); ?>" method="GET" class="w-full md:w-auto flex flex-col md:flex-row gap-2 items-center bg-white p-1.5 rounded-xl border border-slate-200 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 transition-all">
                            ...
                            <?php if(request('search')): ?>
                                <a href="<?php echo e(route('vendors.index')); ?>" class="p-2 text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-lg transition-colors" title="Reset Filter">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(!auth()->user()->isHead()): ?>
                                <a href="<?php echo e(route('vendors.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md">
                            ...
                            <tbody class="bg-white divide-y divide-slate-100">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="font-bold text-slate-800"><?php echo e($vendor->name); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-indigo-600 truncate max-w-[150px]"><?php echo e($vendor->email); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
                                        <div class="truncate max-w-xs" title="<?php echo e($vendor->address); ?>">
                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if(!auth()->user()->isHead()): ?>
                                                <div class="flex justify-center items-center gap-3">
                                                    <a href="<?php echo e(route('vendors.edit', $vendor->id)); ?>" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 p-2 rounded-lg hover:bg-indigo-100 transition" title="Edit">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                                    </a>
                                                    
                                                    <button type="button" onclick="openDeleteModal('<?php echo e(route('vendors.destroy', $vendor->id)); ?>', 'Hapus Vendor <?php echo e($vendor->name); ?>?', 'Yakin ingin menghapus vendor <strong><?php echo e($vendor->name); ?></strong>? Data aset yang terkait akan kehilangan referensi vendor.')" class="text-rose-600 hover:text-rose-900 bg-rose-50 p-2 rounded-lg hover:bg-rose-100 transition" title="Hapus">
...
<?php endif; ?><?php /**PATH C:\laragon\www\app-inventaris\resources\views/vendors/index.blade.php ENDPATH**/ ?>