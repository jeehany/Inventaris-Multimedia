                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if(!auth()->user()->isKepala()): ?>
                                                <div class="flex justify-center items-center gap-3">
                                                    <button onclick="toggleModal('modal-edit-<?php echo e($vendor->id); ?>')" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 p-2 rounded-lg hover:bg-indigo-100 transition" title="Edit">
                                                ...
                                                <?php echo $__env->make('vendors.modal_edit', ['vendor' => $vendor], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
