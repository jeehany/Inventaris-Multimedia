                    ...
                    <div class="flex flex-col md:flex-row justify-between items-end md:items-center gap-4 mb-8">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(!auth()->user()->isHead()): ?>
                                <a href="<?php echo e(route('borrowers.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md whitespace-nowrap">
                                            ...
                                            <?php if(auth()->guard()->check()): ?>
                                                <?php if(!auth()->user()->isHead()): ?>
                                                    <div class="flex justify-center items-center gap-3">
                                                        <a href="<?php echo e(route('borrowers.edit', $b->id)); ?>" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 p-2 rounded-lg hover:bg-indigo-100 transition" title="Edit">
