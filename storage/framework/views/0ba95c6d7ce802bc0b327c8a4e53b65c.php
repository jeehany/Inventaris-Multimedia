...
<div id="modal-edit-<?php echo e($category->id); ?>" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-hidden="true" role="dialog">
    
    
    <div class="flex items-center justify-center min-h-screen px-4 text-center">
        
        
        <div class="fixed inset-0 bg-slate-900 bg-opacity-75 transition-opacity backdrop-blur-sm" onclick="toggleModal('modal-edit-<?php echo e($category->id); ?>')"></div>
            ...
            <form action="<?php echo e(route('categories.update', $category->id)); ?>" method="POST">
                ...
                <div class="bg-white px-6 pt-6 pb-6">
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <button type="button" onclick="toggleModal('modal-edit-<?php echo e($category->id); ?>')" class="text-slate-400 hover:text-slate-500">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="name-<?php echo e($category->id); ?>" class="block text-sm font-semibold text-slate-700 mb-1">Nama Kategori</label>
                            <input type="text" 
                        ...
                        <div>
                            ...
                            <textarea id="desc-<?php echo e($category->id); ?>" 
                                      name="description" 
                                      rows="2"
                                      class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 placeholder-slate-400"><?php echo e(old('description', $category->description)); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-slate-50 px-6 py-4 flex flex-row-reverse gap-3 border-t border-slate-100">
                    ...
                    <button type="button" onclick="toggleModal('modal-edit-<?php echo e($category->id); ?>')" class="bg-white border border-slate-300 text-slate-700 px-4 py-2 rounded-lg hover:bg-slate-50 text-sm font-semibold shadow-sm transition">
                        Batal
                    </button>
                </div>
            </form>
...
</div><?php /**PATH C:\laragon\www\app-inventaris\resources\views/categories/modal_edit.blade.php ENDPATH**/ ?>