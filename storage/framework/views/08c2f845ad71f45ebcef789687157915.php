...
<?php $component->withAttributes([]); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-slate-200">
                <div class="p-6 md:p-8 text-slate-800">
                    ...
                    <div class="mb-8 border-b border-slate-100 pb-4">
                        <h3 class="text-lg font-bold text-slate-800">Jenis Perawatan</h3>
                        <p class="text-sm text-slate-500 mt-1">Kelola kategori dan tipe perawatan aset.</p>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-end md:items-center gap-4 mb-8">
                        ...
                        <form action="<?php echo e(route('maintenance-types.index')); ?>" method="GET" class="w-full md:w-auto flex flex-col md:flex-row gap-2 items-center bg-white p-1.5 rounded-xl border border-slate-200 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 transition-all">
                            ...
                            <?php if(request('search')): ?>
                                <a href="<?php echo e(route('maintenance-types.index')); ?>" class="p-2 text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-lg transition-colors" title="Reset Filter">
                    ...
                    <div class="overflow-x-auto rounded-xl border border-slate-200 shadow-sm">
                        <table class="min-w-full divide-y divide-slate-200">
                            ...
                            <tbody class="bg-white divide-y divide-slate-100">
                                <?php $__empty_1 = true; $__currentLoopData = $maintenanceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-sm font-bold text-slate-800"><?php echo e($type->name); ?></span>
                                        </td>
                                        <td class="px-6 py-4">
                                            <span class="text-sm text-slate-600"><?php echo e($type->description ?? '-'); ?></span>
                                        </td>
                                            ...
                                            <?php if(auth()->guard()->check()): ?>
                                                <?php if(!auth()->user()->isHead()): ?>
                                                    <div class="flex justify-center items-center space-x-3">
                                                        ...
                                                        <button onclick="toggleModal('modal-edit-<?php echo e($type->id); ?>')" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 hover:bg-indigo-100 p-2 rounded-lg transition" title="Edit">
                                                        ...
                                                        <form action="<?php echo e(route('maintenance-types.destroy', $type->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus jenis ini?');">
                                                    ...
                                                    <div id="modal-edit-<?php echo e($type->id); ?>" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-hidden="true">
                                                        <div class="flex items-center justify-center min-h-screen px-4 text-center">
                                                            <div class="fixed inset-0 bg-slate-900 bg-opacity-75 transition-opacity" onclick="toggleModal('modal-edit-<?php echo e($type->id); ?>')"></div>
                                                            <div class="inline-block bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:max-w-md sm:w-full border border-slate-200">
                                                                <form action="<?php echo e(route('maintenance-types.update', $type->id)); ?>" method="POST">
                                                                    ...
                                                                    <div class="bg-white px-6 py-6">
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <input type="text" name="name" value="<?php echo e($type->name); ?>" required class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                                                                        </div>
                                                                        <div class="mb-2">
                                                                            <label class="block text-sm font-medium text-slate-700 mb-1">Deskripsi</label>
                                                                            <textarea name="description" rows="3" class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm"><?php echo e($type->description); ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="bg-slate-50 px-6 py-4 flex flex-row-reverse gap-3">
                                                                        ...
                                                                        <button type="button" onclick="toggleModal('modal-edit-<?php echo e($type->id); ?>')" class="bg-white border border-slate-300 text-slate-700 px-4 py-2 rounded-lg hover:bg-slate-50 text-sm font-medium transition">Batal</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                    ...
                    <div class="mt-8">
                        <?php if($maintenanceTypes instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
                            <?php echo e($maintenanceTypes->links()); ?>
    ...
    <div id="modal-create" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-hidden="true">
        <div class="flex items-center justify-center min-h-screen px-4 text-center">
            ...
            <div class="inline-block bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:max-w-md sm:w-full border border-slate-200">
                <form action="<?php echo e(route('maintenance-types.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="bg-white px-6 py-6">
...
<?php endif; ?><?php /**PATH C:\laragon\www\app-inventaris\resources\views/maintenance_types/index.blade.php ENDPATH**/ ?>