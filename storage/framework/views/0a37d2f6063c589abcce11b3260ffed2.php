                            ...
                            <?php if(auth()->user()->isHead()): ?>
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" class="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-xl z-20 border border-slate-100" style="display: none;">
                                        <a href="<?php echo e(route('borrowings.analysis_pdf', request()->query())); ?>" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-indigo-600">
                                            📊 Laporan Analisa (PDF)
                                        </a>
                                        <div class="border-t border-slate-100 my-1"></div>
                                        <a href="<?php echo e(route('borrowings.exportPdf', request()->query())); ?>" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-emerald-600">
                                            📄 Laporan Peminjaman (PDF)
                                        </a>
                                        <a href="<?php echo e(route('borrowings.exportExcel', request()->query())); ?>" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-green-600">
                                                ...
                                                <?php if(auth()->guard()->check()): ?>
                                                    <?php if(!auth()->user()->isHead()): ?>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <form action="<?php echo e(route('borrowings.destroy', $borrowing->id)); ?>" method="POST" onsubmit="return confirm('Hapus riwayat ini?');">
