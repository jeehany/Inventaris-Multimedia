...
<div id="modal-edit-<?php echo e($b->id); ?>" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-hidden="true" role="dialog">
    <div class="flex items-center justify-center min-h-screen px-4 text-center">
        <div class="fixed inset-0 bg-slate-900 bg-opacity-75 transition-opacity backdrop-blur-sm" onclick="toggleModal('modal-edit-<?php echo e($b->id); ?>')"></div>
        
        <div class="inline-block w-full max-w-md bg-white rounded-xl text-left overflow-hidden shadow-2xl transform transition-all">
            <form method="POST" action="<?php echo e(route('borrowers.update', $b->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="bg-white px-6 pt-6 pb-6">
                    <div class="flex justify-between items-center mb-5 border-b border-slate-100 pb-3">
                        <h3 class="text-lg font-bold text-slate-900">Edit Data Anggota</h3>
                        <button type="button" onclick="toggleModal('modal-edit-<?php echo e($b->id); ?>')" class="text-slate-400 hover:text-rose-500 transition-colors">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-center mb-4">
                            <img src="<?php echo e(asset('storage/'.$b->photo)); ?>" alt="Foto" class="h-16 w-16 rounded-full object-cover border-2 border-indigo-100 shadow-sm">
                        </div>
                        <?php else: ?>
                        <div class="flex items-center justify-center mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="code" value="<?php echo e(old('code', $b->code)); ?>" required 
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $b->name)); ?>" required 
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 placeholder-slate-400">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" value="<?php echo e(old('phone', $b->phone)); ?>" 
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 placeholder-slate-400">
                        </div>
                ...
                <div class="bg-slate-50 px-6 py-4 flex flex-row-reverse gap-3 border-t border-slate-100">
                    ...
                    <button type="button" onclick="toggleModal('modal-edit-<?php echo e($b->id); ?>')" class="bg-white border border-slate-300 text-slate-700 px-4 py-2 rounded-lg hover:bg-slate-50 text-sm font-semibold shadow-sm transition">Batal</button>
                </div>
            </form>
        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\app-inventaris\resources\views/borrowers/modal_edit.blade.php ENDPATH**/ ?>