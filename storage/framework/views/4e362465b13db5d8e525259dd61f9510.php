    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if($req->items && $req->items->count() > 0): ?>
                        <?php $__currentLoopData = $req->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="margin-bottom: 4px;">
                                ...
                                <small style="color:#666;"><?php echo e($item->specification ?? '-'); ?></small>
                            </div>
                ...
                <td class="text-center"><?php echo e($req->items ? $req->items->sum('quantity') : 0); ?></td>
                <td class="text-right">-</td>
                <td class="text-right"><strong>Rp <?php echo e(number_format($req->total_amount, 0, ',', '.')); ?></strong></td>
